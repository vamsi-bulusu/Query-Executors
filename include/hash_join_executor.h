...
class HashJoinExecutor : public AbstractExecutor {
 public:
  ...
  bool ProcessNextRightTuple(Tuple *tuple);
  bool ProcessMatchedValues(Tuple *tuple);
  Tuple CreateTupleFromResult(const Tuple& res) const;
  bool IsMatchingHash(const Tuple& res) const;
 ...
 private:
  ...
  bool getNext;
  std::vector<Tuple> matchedValues;
  Tuple prevVal;
};
